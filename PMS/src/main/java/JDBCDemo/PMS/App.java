...
public class App 
{
    ...
    {
        System.out.println("******AA companya******");
    	...
    	if(input.equalsIgnoreCase("admin")) {
    		...
    		System.out.println("3.update sales by id");
    		System.out.println("4.Display product,supplier and sales");
    		System.out.println("5.sort product by id");
    		System.out.println("6.search product,supplier,sales");
    		System.out.println("7.delete sales");
    		...
    		System.out.println("Enter your choice");
         	...
         	break;
         	case 3:System.out.println("enter id and updated revenue");
         	sdao.updateSales(s.nextInt(), s.nextDouble());
         	break;
         	case 4:System.out.println("Table--Product");
         	dao.getProduct();
         	...
         	break;
         	case 6:System.out.println("enter id to search product");
         	...
         	break;
         	case 7:System.out.println("enter id to delete sales");
         	sdao.deleteSalesById(s.nextInt());
         	break;
         	case 8:System.out.println("enter id to delete supplier");
    		...
    		System.out.println("Enter your choice");
         	...
         	case 2:System.out.println("enter id to search product");
         		dao.getProductBySku(s.nextInt());
         		break;
         	case 3:System.out.println("enter name to search supplier");
     		supdao.searchSupplierByName(s.next());	
            break;
         	default:System.out.println("Invalid choice");
         	}
    	}
